var gulp 		= require('gulp'),
    ...
    autoprixer	= require('gulp-autoprefixer') // Подключаем библиотеку для автоматического добавления префиксов


gulp.task('sass', function(){ // Создаем таск "sass"
    return gulp.src('app/scss/**/*.+(scss|sass)') // Берем источник
        .pipe(sass()) // Преобразуем Sass в CSS посредством gulp-sass
        .pipe(autoprixer(['last 15 versions', '> 1%', 'ie 8', 'ie 7'], {cascade: true})) // Создаем префиксы
...
gulp.task('scripts', function() {
	 return gulp.src([
	 	...
	 	]) // Берем все необходимые библиотеки, кроме файла main.js 
